    ...
    ui(new Ui::MainWindow)
{
    ...
    DrawShape(ui->graphicsView, graphics_scene, pixmap, painter,
              pen, array_1, 0, 53, 34, 21);
    DrawShape(ui->graphicsView, graphics_scene, pixmap, painter,
              pen, array_2, 57, 53, 34, 21);
    DrawShape(ui->graphicsView, graphics_scene, pixmap, painter,
              pen, array_3, 114, 53, 34, 21);
    ...
    DrawShape(ui->graphicsView_2, graphics_scene, pixmap, painter,
              pen, array_1, 0, 53, 34, 21);
    DrawShape(ui->graphicsView_2, graphics_scene, pixmap, painter,
              pen, array_2, 57, 53, 34, 21);
    DrawShape(ui->graphicsView_2, graphics_scene, pixmap, painter,
    ...
    DrawShape(ui->graphicsView_3, graphics_scene, pixmap, painter,
              pen, array_1, 0, 53, 34, 21);
    DrawShape(ui->graphicsView_3, graphics_scene, pixmap, painter,
              pen, array_2, 57, 53, 34, 21);
    DrawShape(ui->graphicsView_3, graphics_scene, pixmap, painter,
...
{
    MousePressedFunction(ui->label_8, ui->graphicsView->x_press_value,
                         ui->graphicsView->y_press_value, 0);
}

void MainWindow::OnMiddleMousePressedFunction()
{
    MousePressedFunction(ui->label_11, ui->graphicsView_2->x_press_value,
                         ui->graphicsView_2->y_press_value, 190);
}

void MainWindow::OnRightMousePressedFunction()
{
    MousePressedFunction(ui->label_12, ui->graphicsView_3->x_press_value,
                         ui->graphicsView_3->y_press_value, 390);
}

void MainWindow::MousePressedFunction(QLabel *label, int tmp_x_press_value,
                                      int tmp_y_press_value, int x_sum)
{
...
{
    MouseMovedFunction(ui->label_8, ui->graphicsView->x_first_move_value,
                       ui->graphicsView->y_first_move_value,
                       ui->graphicsView->y_move_value, 0);
}

void MainWindow::OnMiddleMouseMovedFunction()
{
    MouseMovedFunction(ui->label_11, ui->graphicsView_2->x_first_move_value,
                       ui->graphicsView_2->y_first_move_value, ui->graphicsView_2->y_move_value,
                       190);
}

void MainWindow::OnRightMouseMovedFunction()
{
   MouseMovedFunction(ui->label_12, ui->graphicsView_3->x_first_move_value,
                      ui->graphicsView_3->y_first_move_value, ui->graphicsView_3->y_move_value,
                      390);
}

void MainWindow::MouseMovedFunction(QLabel *label, int tmp_x_first_move_value,
                                    int tmp_y_first_move_value, int tmp_y_move_value,
                                    int x_sum)
{
    if (moving_state == true) {
        ...
        if (y_coordinaat >= 10 && y_coordinaat <= 690 &&
            y_move_coordinaat >= 10 && y_move_coordinaat <= 690) {
...
{
    MouseReleasedFunction(ui->graphicsView, ui->label_8, ui->graphicsView->y_first_move_value,
                          ui->graphicsView->x_last_move_value, ui->graphicsView->y_last_move_value);
}

void MainWindow::OnMiddleMouseReleasedFunction()
{
    MouseReleasedFunction(ui->graphicsView_2, ui->label_11, ui->graphicsView_2->y_first_move_value,
                          ui->graphicsView_2->x_last_move_value, ui->graphicsView_2->y_last_move_value);
}

void MainWindow::OnRightMouseReleasedFunction()
{
    MouseReleasedFunction(ui->graphicsView_3, ui->label_12, ui->graphicsView_3->y_first_move_value,
                          ui->graphicsView_3->x_last_move_value, ui->graphicsView_3->y_last_move_value);
}

void MainWindow::MouseReleasedFunction(QGraphicsView *graphics_view, QLabel *label,
                                       int tmp_y_first_move_value, int tmp_x_last_move_value,
                                       int tmp_y_last_move_value)
{
    if (released_state == true && moving_state == true) {
        ...
        DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, tmp_array_1,
                  0, 53, 680 / tmp_array_1.size(), tmp_array_1.size());
        DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, tmp_array_2,
                  57, 53, 680 / tmp_array_2.size(), tmp_array_2.size());
        DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, tmp_array_3,
                  114, 53, 680 / tmp_array_3.size(), tmp_array_3.size());
...
void MainWindow::MouseDoubleClickFunction(QGraphicsView *graphics_view, QLabel *label, int x_sum)
{
    ...
    DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, array_1,
              0, 53, 34, 21);
    DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, array_2,
              57, 53, 34, 21);
    DrawShape(graphics_view, graphics_scene, pixmap, painter, pen, array_3,
              114, 53, 34, 21);
...
void MainWindow::DrawShape(QGraphicsView *graphics_view, QGraphicsScene *graphics_scene,
                           QPixmap *pixmap, QPainter *painter, QPen pen,
                           QList<int> array, int x, int width, int height,
