...
private:
    ...
    void MousePressedFunction(QLabel *label, int tmp_x_press_value,
                              int tmp_y_press_value, int x_sum);
    void MouseMovedFunction(QLabel *label, int tmp_x_first_move_value,
                            int tmp_y_first_move_value, int tmp_y_move_value,
                            int x_sum);
    void MouseReleasedFunction(QGraphicsView *graphics_view, QLabel *label,
    ...
    void DrawShape(QGraphicsView *graphics_view, QGraphicsScene *graphics_scene,
                   QPixmap *pixmap, QPainter *painter, QPen pen, QList<int> array,
