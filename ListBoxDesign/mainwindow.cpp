    ...
    ui(new Ui::MainWindow)
{
    ...
    for (int i = 0; i < 10; i++) {
        ...
        push_buttons[i]->setStyleSheet("QPushButton { background-color: rgb(94, 94, 94); "
                                       "border: 1px solid black; border-radius: 5px; "
                                       "width: 45px; height: 45px; } QPushButton:hover { "
        ...
        label_1->setStyleSheet("QLabel { border: 0px; font-size: 14px; padding-left: 15px; "
                               "color: rgb(240, 240, 240); }");
        label_1->setText("Text1");

        QLabel *label_2 = new QLabel();
        label_2->setGeometry(100, 0, 30, 40);
        label_2->setStyleSheet("QLabel { border: 0px; font-size: 14px; padding-left: 15px; "
                               "color: rgb(240, 240, 240); }");
        ...
        tmp_widget->setStyleSheet("QWidget { border: 0px; } QWidget:hover { "
...
void MainWindow::OnHandleButton(int button_id)
{
    if (buttons_state[button_id] == false) {
        push_buttons[button_id]->setStyleSheet("QPushButton { background-color: rgb(194, 194, 194); "
                                               "border: 1px solid black; border-radius: 5px; "
                                               "width: 45px; height: 45px; }");
        buttons_state[button_id] = true;
    } else if (buttons_state[button_id] == true) {
        push_buttons[button_id]->setStyleSheet("QPushButton { background-color: rgb(94, 94, 94); "
                                               "border: 1px solid black; border-radius: 5px; "
                                               "width: 45px; height: 45px; } QPushButton:hover { "
                                               "background-color: rgb(194, 194, 194); }");
